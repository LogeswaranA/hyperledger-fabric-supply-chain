...
type purchaseorder struct {
    ...
    POPlacedBy string `json:"POPlacedBy"`
    TotalUnits string `json:"TotalUnits"`
    PricePerUnit string `json:"PricePerUnit"`
}

func (cc *purchaseorderChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
    ...
    data := purchaseorder{ Id: args[0], CreatedOn: dateValue1, CreatedBy: args[2], IsDelete: boolValue3, Warehouse_id: args[4], Motherboard_id: args[5], PONumber: args[6], POPlacedBy: args[7], TotalUnits: args[8], PricePerUnit: args[9] }
...
func (cc *purchaseorderChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *purchaseorderChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *purchaseorderChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *purchaseorderChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *purchaseorderChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *purchaseorderChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *purchaseorderChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(purchaseorderChaincode))
	if err != nil {
