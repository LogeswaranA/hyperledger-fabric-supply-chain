...
type distributorChaincode struct {
}
...
func (cc *distributorChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
    ...
    data := distributor{ Id: args[0], Participant_id: args[1], CreatedOn: dateValue2, CreatedBy: args[3], IsDelete: boolValue4, Name: args[5], Address: args[6], License: args[7], Expiry: args[8], Modifiedby: args[9] }
...
func (cc *distributorChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *distributorChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *distributorChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *distributorChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *distributorChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *distributorChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *distributorChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(distributorChaincode))
	if err != nil {
